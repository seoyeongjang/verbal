...
이 스크립트는 `VERBAL_DEMO=true`를 강제로 적용합니다. 따라서 Firebase Auth, Firebase Storage, Cloud Functions, Deepgram API key, Google Play 앱 등록 없이 실행됩니다.
